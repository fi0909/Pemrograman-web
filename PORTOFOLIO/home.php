						...
						<div class="row">
							<div class="col-md-5 animate-box">
								<div class="owl-carousel3">
									<div class="item">
										<img class="img-responsive about-img" src="' . htmlspecialchars($row["gambar"]) . '" alt="Gambar 1">
									</div>
									<div class="item">
										<img class="img-responsive about-img" src="' . htmlspecialchars($row["gambar2"]) . '" alt="Gambar 2">
									</div>
								</div>
							</div>
							<div class="col-md-6 col-md-push-1 animate-box">
								<div class="about-desc">
									<div class="owl-carousel3">
										<div class="item">
											<h2><span>' . htmlspecialchars($row["nama_depan"]) . '</span> <span>' . htmlspecialchars($row["nama_belakang"]) . '</span></h2>
										</div>
										<div class="item">
											<h2><span>I\'m</span><span>Progammer</span></h2>
										</div>
									</div>
									<div class="desc">
										<div class="rotate">
										...
										<p class="colorlib-social-icons">
											<a href="' . htmlspecialchars($row["github_link"]) . '"><i class="icon-github2"></i></a>
											<a href="' . htmlspecialchars($row["instagram_link"]) . '"><i class="icon-instagram2"></i></a>
											<a href="' . htmlspecialchars($row["youtube_link"]) . '"><i class="icon-youtube"></i></a>
										</p>
									...
									<div class="services animate-box">
										...
										<ul>
											<?php foreach($subskills as $subskill) { ?>
												<li><?php echo htmlspecialchars($subskill); ?></li>
											<?php } ?>
										</ul>
									</div>
								</div>
			...
			<div class="container">
				...
				if ($result->num_rows > 0) {
				    while ($row = $result->fetch_assoc()) {
						...
						echo '			<div class="desc">';
						echo '					<p class="read"><a href="work.php">View details</a></p>';			
						echo '				</div>';
						echo '			</div>';
				        echo '    </div>';
				        echo '</div>';
